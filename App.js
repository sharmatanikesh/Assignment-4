...
const RestaurantCard =(props)=>{
    const {resData} =props;
    const {name,avgRating,deliveryTime,cuisines,cloudinaryImageId}=resData?.data;
    return(
        <div className="res-card" style={{backgroundColor:"#f0f0f0"}}>
            <img  className='res-logo' src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId }alt="Background Images" />
            <h3 id='name'>{name} </h3>
            <h4 id='cuisine'>Cuisines: {cuisines.join(', ')}</h4>
            <h4 id='rating'>Rating: {avgRating}</h4>
            <h4 className='time'>Delivering Time: {deliveryTime} minutes</h4>
        </div>
    );
};
